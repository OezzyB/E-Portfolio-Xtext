...
import org.example.methods.methods.MethodsFactory;
 ...
 * @generated
 */
public class MethodsPackageImpl extends EPackageImpl implements MethodsPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.example.methods.methods.MethodsPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MethodsPackageImpl()
  {
    super(eNS_URI, MethodsFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MethodsPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MethodsPackage init()
  {
    if (isInited) return (MethodsPackage)EPackage.Registry.INSTANCE.getEPackage(MethodsPackage.eNS_URI);

    // Obtain or create and register package
    MethodsPackageImpl theMethodsPackage = (MethodsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MethodsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MethodsPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMethodsPackage.createPackageContents();

    // Initialize created meta-data
    theMethodsPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMethodsPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MethodsPackage.eNS_URI, theMethodsPackage);
    return theMethodsPackage;
  }
   ...
   * @generated
   */
  public EReference getModel_Mehtods()
  {
   ...
   * @generated
   */
  public EAttribute getValue_ValueOthers()
  {
   ...
   * @generated
   */
  public MethodsFactory getMethodsFactory()
  {
    return (MethodsFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__MEHTODS);
    ...
    createEAttribute(valueEClass, VALUE__VALUE_OTHERS);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModel_Mehtods(), this.getMethod(), null, "mehtods", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getMethod_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAttribute_AttrType(), ecorePackage.getEString(), "attrType", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getValue_ValueOthers(), ecorePackage.getEString(), "valueOthers", null, 0, 1, Value.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
